    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-6 lg:px-8 py-12">
        ...
        <article className="font-sans text-base leading-relaxed text-foreground/90 space-y-5">
          ...
          <h2 className="text-2xl md:text-3xl font-serif font-bold uppercase text-foreground pt-8">Interpretation and Definitions</h2>

          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Interpretation</h3>
          <p>
            The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
          </p>

          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Definitions</h3>
          <p>For the purposes of this Privacy Policy:</p>
          <p><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</p>
          <p><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
          <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Styling Engine.</p>
          ...
          <p><strong>Website</strong> refers to Styling Engine, accessible from <a href="https://crafting-joyful-apps.lovable.app/" className="text-primary underline">https://crafting-joyful-apps.lovable.app/</a>.</p>
          <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>

          <h2 className="text-2xl md:text-3xl font-serif font-bold uppercase text-foreground pt-8">Collecting and Using Your Personal Data</h2>

          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Types of Data Collected</h3>

          <h4 className="text-lg font-serif font-bold uppercase text-foreground pt-2">Personal Data</h4>
          ...
          <h4 className="text-lg font-serif font-bold uppercase text-foreground pt-2">Usage Data</h4>
          ...
          <h4 className="text-lg font-serif font-bold uppercase text-foreground pt-2">Tracking Technologies and Cookies</h4>
          ...
          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Use of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Retention of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Transfer of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Delete Your Personal Data</h3>
          ...
          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Disclosure of Your Personal Data</h3>

          <h4 className="text-lg font-serif font-bold uppercase text-foreground pt-2">Business Transactions</h4>
          <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>

          <h4 className="text-lg font-serif font-bold uppercase text-foreground pt-2">Law enforcement</h4>
          <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>

          <h4 className="text-lg font-serif font-bold uppercase text-foreground pt-2">Other legal requirements</h4>
          ...
          <h3 className="text-xl font-serif font-bold uppercase text-foreground pt-4">Security of Your Personal Data</h3>
          ...
          <h2 className="text-2xl md:text-3xl font-serif font-bold uppercase text-foreground pt-8">Links to Other Websites</h2>
          <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
          <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

          <h2 className="text-2xl md:text-3xl font-serif font-bold uppercase text-foreground pt-8">Changes to this Privacy Policy</h2>
          <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
          <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
          <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>

          <h2 className="text-2xl md:text-3xl font-serif font-bold uppercase text-foreground pt-8">Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="list-disc pl-6 space-y-1">
            <li>By email: <a href="mailto:jwoodard@mba2027.hbs.edu" className="text-primary underline">jwoodard@mba2027.hbs.edu</a></li>
          </ul>
        </article>
      </div>
    </div>
