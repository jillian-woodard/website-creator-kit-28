    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-md bg-card border border-border rounded-3xl shadow-soft-lg p-8 md:p-10">
        ...
        <p className="text-secondary font-sans text-center mb-8">
          {isSignUp
            ? "Sign up to save your style, closet, and picks."
            : "Sign in to access your style, closet, and picks."}
        </p>
        ...
        {!isSignUp && (
          <button
            ...
            className="mt-4 text-sm text-secondary font-sans hover:text-foreground transition-colors block mx-auto"
          >
        ...
        <button
          ...
          className="mt-6 text-sm text-secondary font-sans hover:text-foreground transition-colors block mx-auto"
        >
